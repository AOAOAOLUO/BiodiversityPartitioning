...
save(t.m.output,file='code/alpha_model/table_pred/type1/bio1_10times_bio12_alpha_999_1.rdata')
...
for (i in 2:10) {
  ...
  t.m.output <- data.frame(bio1=t.m$Var1,bio12=t.m$Var2,alpha.max=t.m.pred)
  save(t.m.output,file=paste0('code/alpha_model/table_pred/type1/bio1_10times_bio12_alpha_999_',i,'.rdata'))
}
