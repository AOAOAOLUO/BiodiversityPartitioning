...
m <- raster('D:/LuoAo/LP/data/clim/CHELSA_swb_1981-2010_V.2.1.tif')
...
save(t.m.output,file='code/alpha_model/table_pred/type3/bio1_10times_bio12_alpha_999_1.rdata')
...
for (i in 2:10) {
  ...
  t.m.output <- data.frame(bio1=t.m$Var1,bio12=t.m$Var2,alpha.max=t.m.pred)
  save(t.m.output,file=paste0('code/alpha_model/table_pred/type3/bio1_10times_bio12_alpha_999_',i,'.rdata'))
}
